...
from qtpy.QtCore import QObject, QUrl, qDebug, qCritical, QEvent, QPoint, QPointF, Qt
...
class FboItem(QQuickFramebufferObject):
    ...
    def selectModel(self, x, y):
        self.__m_lastMouseLeftButton = QMouseEvent(QEvent.Type.None_, QPointF(x,y), Qt.LeftButton, Qt.LeftButton, Qt.NoModifier)
        self.__m_lastMouseLeftButton.ignore()
        self.update()
    def resetModelSelection(self):
        self.__m_lastMouseLeftButton = QMouseEvent(QEvent.Type.None_, QPointF(-1,-1), Qt.LeftButton, Qt.LeftButton, Qt.NoModifier)
        self.__m_lastMouseLeftButton.ignore()
        self.update()
