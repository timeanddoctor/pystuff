...
# Property
radprop = vtk.vtkProperty()
radprop.SetColor(.0, .0, 1.)
polaxes.SetSecondaryRadialAxesProperty(radprop)

# Only last axis red
#polaxes.GetPolarArcsProperty().SetColor( 1., .0, 0. )
polprop = vtk.vtkProperty()
polprop.SetColor(1.0, .0, 0.)
polaxes.SetSecondaryPolarArcsProperty(polprop)
